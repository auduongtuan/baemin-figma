...
import { LocaleData, LocaleItem } from "../../lib/localeData";
...
export function saveLocaleData(localeData: LocaleData) {
  ...
  if(localeData) {
    ...
    filterLocaleData.localeItems = filterLocaleData.localeItems.filter(localeItem => !('fromLibrary' in localeItem) || !localeItem.fromLibrary);
